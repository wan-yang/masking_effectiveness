...
# get settings for counter-factual runs assuming all mask at home
...
# COUNTER FACTUAL
MASKATHOME.t = T # set this to TRUE only when testing a very specific scenario that ppl also mask at home
